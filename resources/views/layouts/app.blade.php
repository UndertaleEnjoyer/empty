...
<body class="font-sans antialiased">
    ...
    <ul id="userDropdownMenu"
        style="display:none; position:absolute; right:0; top:100%; min-width:200px;
               background:#fff; border-radius:8px; box-shadow: 0 8px 24px rgba(0,0,0,0.15);
               list-style:none; padding:8px 0; margin:4px 0 0 0; z-index:9999;">
...
@endauth
    ...
    <!-- Fixed Exit Button -->
    @auth
        <div class="fixed-exit-button-container">
            <form method="POST" action="{{ route('logout') }}" id="exitForm" style="margin: 0;">
                @csrf
                <button type="submit" class="fixed-exit-button" title="Выйти из аккаунта">
